...
// Calculate accumulated earnings based on days elapsed
...
// Optimized Admin Control Component
...
const DashboardPage = () => {
  ...
  const calculateAndUpdateBalance = useCallback(async (data) => {
    ...
    // Update Firestore if earnings changed significantly
  ...
  // Auto-update earnings every hour
  useEffect(() => {
